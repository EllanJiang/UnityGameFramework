...
namespace UnityGameFramework.Editor.AssetBundleTools
{
    ...
    public interface IBuildEventHandler
    {
        ...
        /// <param name="outputFullPath">为可更新模式生成的所有文件存放于此路径。若游戏是网络游戏，生成结束后应将此目录上传至 Web 服务器，供玩家下载用。</param>
        /// <param name="outputPackedPath">为可更新模式生成的文件存放于此路径。若游戏是网络游戏，生成结束后将此目录中对应平台的文件拷贝至 StreamingAssets 后打包 App 即可。</param>
        void PreProcessBuild(Platform platform, string workingPath, string outputPackagePath, string outputFullPath, string outputPackedPath);
        ...
        /// <param name="outputFullPath">为可更新模式生成的所有文件存放于此路径。若游戏是网络游戏，生成结束后应将此目录上传至 Web 服务器，供玩家下载用。</param>
        /// <param name="outputPackedPath">为可更新模式生成的文件存放于此路径。若游戏是网络游戏，生成结束后将此目录中对应平台的文件拷贝至 StreamingAssets 后打包 App 即可。</param>
        void PostProcessBuild(Platform platform, string workingPath, string outputPackagePath, string outputFullPath, string outputPackedPath);
    }
}
