...
namespace UnityGameFramework.Runtime
{
    ...
    public abstract class DataTableHelperBase : MonoBehaviour, IDataTableHelper
    {
        ...
        public bool LoadDataTable(object dataTableObject, LoadType loadType, object userData)
        {
            LoadDataTableInfo loadDataTableInfo = (LoadDataTableInfo)userData;
            return LoadDataTable(loadDataTableInfo.DataRowType, loadDataTableInfo.DataTableName, loadDataTableInfo.DataTableNameInType, dataTableObject, loadType, loadDataTableInfo.UserData);
        }
        ...
        /// <param name="userData">用户自定义数据。</param>
        /// <returns>是否加载成功。</returns>
        protected abstract bool LoadDataTable(Type dataRowType, string dataTableName, string dataTableNameInType, object dataTableObject, LoadType loadType, object userData);
    }
}
